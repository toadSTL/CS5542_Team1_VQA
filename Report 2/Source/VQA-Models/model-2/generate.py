...
from Models import VQA_model_attention,vgg16
import data_loader
import argparse
import numpy as np
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default=None,
                       help='C:/convolutional-vqa-master/Data/Models2/model24.ckpt.data-00000-of-00001')
    ...
    parser.add_argument('--cnn_model', type=str, default="resnet",
                       help='CNN model')
    parser.add_argument('--text_model', type=str, default="lstm",
                       help='bytenet/lstm')
    parser.add_argument('--question', type=str, default="What does the dog want to chew on",
                       help='question about the image')
    parser.add_argument('--image_file', type=str, default="C:/convolutional-vqa-master/Data/images/abstract_v002_train2015_000000000002.jpg",
