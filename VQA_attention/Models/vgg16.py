...
def create_vgg_model(img_dim, only_conv = False):
    ...
    # config.report_tensor_allocations_upon_oom = True
    ...
    sess = tf.Session()#config=tf.ConfigProto(gpu_options=gpu_opts))#config=config)
...
if __name__ == '__main__':
    ...
    vgg = vgg16(imgs, '../Data/CNNModels/vgg16_weights.npz', sess)

    img1 = imread('COCO_val2014_000000000042.jpg')
