...
def main():
    ...
    print("Image id list:")
    print("Length: {}".format(len(image_id_list)))
    print("0th: {}".format(image_id_list[0]))
    print("1st: {}".format(image_id_list[1]))
    print("Type: {}".format(type(image_id_list[0])))
    ...
    while idx < len(image_id_list):
        ...
        for i in range(0, args.batch_size):
            ...
            image_file = join('Data', 'train2014/COCO_train2014_%.12d.jpg'%(image_id_list[idx]))#'%s2014/COCO_%s2014_%.12d.jpg'%(args.split, args.split, image_id_list[idx]) )
